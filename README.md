...
**This is a framework repository** - it provides the core tools and workflows. To use this framework in your repository:
1. Follow the [Installation Guide](docs/installation.md) to set up the framework
...
1. **[Installation Guide](docs/installation.md)** - Set up the framework in your repository
...
- **[Installation Guide](docs/installation.md)** - Install the framework in your repository
